...
#}
        ...
        PROMPT = inp
        NPROMPT= "Ugly,Duplicate,Morbid,Multilated,Extra Fingers,Multilated Hands,Poorly Drawn Hands,Poorly Drawn Face,Mutation,Deformed,Blurry,Bad Anatomy,Extra Limbs,Cloned Face,Gross Proportions,Malformed Limbs,Missing Arms,Missing Legs,Mulated Hands,Too Many Fingers,Long Neck"
        ...
        image_urls = model.predict(prompt=RPROMPT,negative_prompt=NPROMPT)
        img_name = PROMPT[:12]
